...
const restoreSessionMessages = (savedMessages = []) => savedMessages.map((item) => (
  item.role === 'user'
    ...
    : {
        ...
        replyUrdu: item.replyUrdu,
        meaning: item.meaning,
        meaningUrdu: item.meaningUrdu,
        ...
        setTopics((current) => current.map((item) => (
          item.id === selectedTopic.id
            ? {
                ...
                questionUrduMeanings: practice.questionUrduMeanings || [],
    ...
    try {
      ...
      setMessages((current) => {
        ...
        const nextAssistant = {
          ...
          replyUrdu: data.replyUrdu,
          meaning: data.meaning,
          meaningUrdu: data.meaningUrdu,
